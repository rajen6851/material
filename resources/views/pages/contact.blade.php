<x-app-layout>
        ...
        <div class="max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div class="space-y-3 max-w-3xl">
                    <span class="text-[10px] uppercase font-bold tracking-[0.28em] text-[#c09b5a] block">CLIENT SERVICES
                        &amp; SHOWROOM</span>
                    <h1
                        class="font-serif-pristo text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight">
                        Connect with Pristo
                    </h1>
                    <p class="text-xs sm:text-sm text-[#a39e97] leading-relaxed pt-1">
                        Whether you are an architect detailing custom project specifications or a homeowner curating
                        your dream bath &amp; living space, our material experts are here to assist.
                    </p>
                </div>
    ...
    <div class="max-w-[1550px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        @if(session('success'))
            <div
                class="mb-8 p-4 bg-[#f5f0ea] border-l-4 border-[#c09b5a] rounded-r-2xl text-[#171615] flex items-center justify-between shadow-sm">
                <div class="flex items-center gap-3">
                    <span
                        class="w-8 h-8 rounded-full bg-[#c09b5a] text-white flex items-center justify-center font-bold text-sm">✓</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 space-y-8">
                <div class="bg-white border border-[#ded7cd] rounded-3xl p-8 shadow-xs space-y-6">
                    <div>
                        <span
                            class="text-[10px] uppercase font-bold tracking-[0.2em] text-[#c09b5a] block mb-1">EXPERIENCE
                            CENTER</span>
                        <h2 class="font-serif-pristo text-2xl font-bold text-[#171615]">Visit Our Partner Showroom</h2>
                        <h3 class="font-serif-pristo text-xl font-bold text-[#171615]">Explore selected sanitaryware,
                            faucets, tiles and accessories in person with Pristo assistance.</h3>
                        <p class="text-xs text-[#55504a] mt-2 leading-relaxed">
                            Touch and feel over 500+ premium porcelain slabs, designer sanitaryware, freestanding tubs,
                            and brass fittings in person.
                        </p>
                    </div>
                    ...
                    <div class="space-y-4 pt-2 border-t border-[#f0ebe3]">
                        <div class="flex items-start gap-3.5 text-xs text-[#333]">
                            <div
                                class="w-9 h-9 rounded-xl bg-[#f7f4ef] border border-[#e8e2d8] flex items-center justify-center text-[#c09b5a] flex-shrink-0">
                            ...
                            <div>
                                ...
                                <span class="text-[11px] text-[#8c857b] block mt-0.5">
                                    Bengaluru & surrounding areas
                                    Direct dispatch from our authorised dealer & supplier network
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3.5 text-xs text-[#333]">
                            ...
                            <div>
                                ...
                                <a href="tel:+916362346660"
                                    class="hover:text-[#c09b5a] font-semibold transition text-sm">+91 95878 00660</a>
                                <span class="text-[11px] text-[#8c857b] block mt-0.5">Mon to Sat: 9:30 AM – 7:30
                                    PM</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3.5 text-xs text-[#333]">
                            ...
                            <div>
                                ...
                                <a href="mailto:pristoenterprises@gmail.com"
                                    class="hover:text-[#c09b5a] transition">pristoenterprises@gmail.com</a>
                                <span class="text-[11px] text-[#8c857b] block mt-0.5">For official BOQs, CAD drawings,
                                    and trade inquiries</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-[#f7f4ef] border border-[#e8e2d8] rounded-2xl p-5 space-y-2">
                        <span class="text-[10px] uppercase font-bold tracking-wider text-[#c09b5a] block">ARCHITECTS
                            &amp; B2B</span>
                    ...
                    <div class="bg-[#f7f4ef] border border-[#e8e2d8] rounded-2xl p-5 space-y-2">
                        <span class="text-[10px] uppercase font-bold tracking-wider text-[#c09b5a] block">LOGISTICS
                            &amp; FREIGHT</span>
                        <h4 class="font-bold text-xs text-[#171615]">Delivery Desk</h4>
                        <p class="text-[11px] text-[#666] leading-relaxed">
                            Specialized hydraulic tail-lift vehicles &amp; crate handling across Bangalore and
                            Karnataka.
                        </p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-7 bg-white border border-[#ded7cd] rounded-3xl p-8 sm:p-10 shadow-sm space-y-6">
                <div>
                    <span class="text-[10px] uppercase font-bold tracking-[0.2em] text-[#c09b5a] block mb-1">INQUIRY
                        FORM</span>
                    <h2 class="font-serif-pristo text-2xl sm:text-3xl font-bold text-[#171615]">Send a Message</h2>
                    <p class="text-xs text-[#55504a] mt-1">
                        Fill out the details below and an experienced materials specialist will get back to you with
                        guidance and cut-sheets.
                    </p>
                </div>
                ...
                <form action="{{ route('contact.submit') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="email" id="email" name="email"
                                value="{{ old('email', auth()->user()?->email) }}" placeholder="e.g. rahul@example.com"
                                required
                                class="w-full bg-[#faf8f5] border border-[#ded7cd] focus:border-[#c09b5a] focus:bg-white rounded-xl px-4 py-3 text-xs text-[#171615] focus:outline-none transition">
                            @error('email')
                                <p class="text-[11px] text-red-500 font-semibold">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="tel" id="phone" name="phone"
                                value="{{ old('phone', auth()->user()?->mobile) }}" placeholder="+91 98765 43210"
                                required
                                class="w-full bg-[#faf8f5] border border-[#ded7cd] focus:border-[#c09b5a] focus:bg-white rounded-xl px-4 py-3 text-xs text-[#171615] focus:outline-none transition">
                            @error('phone')
                                <p class="text-[11px] text-red-500 font-semibold">{{ $message }}</p>
                        ...
                        <div class="space-y-1.5">
                            <label for="inquiry_type"
                                class="block text-xs font-bold uppercase tracking-wider text-[#55504a]">
                            ...
                            <select id="inquiry_type" name="inquiry_type" required
                                ...
                                <option value="Architect & Contractor Trade Desk" {{ old('inquiry_type') == 'Architect & Contractor Trade Desk' ? 'selected' : '' }}>Architect &amp; B2B Trade Pricing
                                </option>
                    ...
                    <div class="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <button type="submit" style="background-color: #171615; color: #ffffff;"
